"""
Training script for Binary Classification Model on Google Cloud.

Usage:
    python train_binary.py \
        --gcs-data gs://your-bucket/segments \
        --output-dir ./runs/binary \
        --epochs 50 \
        --batch 64
"""
...
def main():
    parser = argparse.ArgumentParser(description="Train binary classification model on Google Cloud")
    ...
    # Output arguments
    parser.add_argument('--output-dir', type=str, default='./runs/binary', help='Output directory for checkpoints')
