"""
Training script for MI Minimization Model on Google Cloud.

Usage:
    python train_mi_minimization.py \
        --gcs-data gs://your-bucket/segments \
        --output-dir ./runs/mi_minimization \
        --epochs 50 \
        --batch 64
"""
...
def main():
    parser = argparse.ArgumentParser(description="Train MI minimization model on Google Cloud")
    ...
    parser.add_argument('--mi-weight', type=float, default=0.1, help='Weight for MI minimization loss')
    parser.add_argument('--mi-hidden-dim', type=int, default=64, help='Hidden dimension for MI estimator')
    ...
    # Output arguments
    parser.add_argument('--output-dir', type=str, default='./runs/mi_minimization', help='Output directory for checkpoints')
    ...
    model_config = {
        ...
        'mi_hidden_dim': args.mi_hidden_dim,
