"""
Training script for Supervised Contrastive Learning Model on Google Cloud.

Usage:
    python train_supcon.py \
        --gcs-data gs://your-bucket/segments \
        --output-dir ./runs/supcon \
        --epochs 50 \
        --batch 64
"""
...
def main():
    parser = argparse.ArgumentParser(description="Train supervised contrastive learning model on Google Cloud")
    ...
    # Output arguments
    parser.add_argument('--output-dir', type=str, default='./runs/supcon', help='Output directory for checkpoints')
