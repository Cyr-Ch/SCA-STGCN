"""
Training script for Supervised Contrastive + FiLM Model on Google Cloud.

Usage:
    python train_supcon_film.py \
        --gcs-data gs://your-bucket/segments \
        --output-dir ./runs/supcon_film \
        --epochs 50 \
        --batch 64
"""
...
def main():
    parser = argparse.ArgumentParser(description="Train supervised contrastive + FiLM model on Google Cloud")
    ...
    parser.add_argument('--supcon-weight', type=float, default=0.1, help='Weight for supervised contrastive loss')
    parser.add_argument('--supcon-temp', type=float, default=0.07, help='Temperature for contrastive loss')
    ...
    # Output arguments
    parser.add_argument('--output-dir', type=str, default='./runs/supcon_film', help='Output directory for checkpoints')
