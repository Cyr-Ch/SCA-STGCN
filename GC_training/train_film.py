"""
Training script for FiLM Attention Model on Google Cloud.

Usage:
    python train_film.py \
        --gcs-data gs://your-bucket/segments \
        --output-dir ./runs/film_attention \
        --epochs 50 \
        --batch 64
"""
...
def main():
    parser = argparse.ArgumentParser(description="Train FiLM attention model on Google Cloud")
    ...
    # Output arguments
    parser.add_argument('--output-dir', type=str, default='./runs/film_attention', help='Output directory for checkpoints')
