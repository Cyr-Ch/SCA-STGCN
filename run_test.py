...
# Now import using absolute imports by modifying the modules
...
# Load utils module  
spec = importlib.util.spec_from_file_location("utils", "utils/__init__.py")
